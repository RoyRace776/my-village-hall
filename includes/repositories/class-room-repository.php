...
class MYVH_Room_Repository {
    ...
    public function create($data) {
        ...
        if ($result === false) {
            error_log('MYVH Room Repository Error (create): ' . $this->wpdb->last_error);
            return false;
        }
    ...
    public function get_all($args = array()) {
        ...
        if ($results === null) {
            error_log('MYVH Room Repository Error (get_all): ' . $this->wpdb->last_error);
        }
    ...
    public function get_by_id($id) {
        ...
        if ($result === null && $this->wpdb->last_error) {
            error_log('MYVH Room Repository Error (get_by_id): ' . $this->wpdb->last_error);
        }
    ...
    public function update($data, $id) {
        ...
        if ($result === False) {
            error_log('MYVH Room Repository Error (update): ' . $this->wpdb->last_error);
            return false;
        }
    ...
    public function delete($id) {
        ...
        if ($result === false) {
            error_log('MYVH Room Repository Error (delete): ' . $this->wpdb->last_error);
            return false;
        }
