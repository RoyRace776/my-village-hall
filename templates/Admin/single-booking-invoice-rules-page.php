        ...
        <table class="wp-list-table widefat striped" id="myvh-single-booking-rules-table">
            <thead>
                <tr>
                    ...
                    <th><?php esc_html_e('Sort', 'my-village-hall'); ?></th>
            ...
            <tbody>
                <?php if (empty($rules)): ?>
                    <tr class="myvh-rule-row">
                        ...
                        <td><input type="number" name="rules[0][sort_order]" value="0" min="0" class="small-text"></td>
                ...
                <?php else: ?>
                    <?php foreach ($rules as $index => $rule): ?>
                        <tr class="myvh-rule-row">
                            ...
                            <td><input type="number" name="rules[<?php echo intval($index); ?>][sort_order]" value="<?php echo intval($rule['SortOrder'] ?? 0); ?>" min="0" class="small-text"></td>
...
(function () {
    ...
    function buildRow(index) {
        ...
        row.innerHTML = '' +
            ...
            '<td><input type="number" name="rules[' + index + '][sort_order]" value="0" min="0" class="small-text"></td>' +
